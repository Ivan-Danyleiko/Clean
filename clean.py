...
# noinspection PyTypeChecker
def process_folder(folder_path: str, destination_folder: str, empty_folders: list) -> None:
    """
    Process the contents of a folder, categorize files, and move them to appropriate destinations.

    Args:
        folder_path (str): The path to the folder to be processed.
        destination_folder (str): The destination folder for categorized files.
